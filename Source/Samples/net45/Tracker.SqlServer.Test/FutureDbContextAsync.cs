...
namespace Tracker.SqlServer.Test
    {
    public class FutureDbContextAsync
        {
        [Fact]
        public void PageTest()
            ...
            var tasks = q2.ToListAsync().Result;
            int total = q1.Value;
        ...
        public void SimpleTest()
            ...
            var users = q1.ToListAsync().Result;
        ...
        public void FutureCountReverseTest()
            ...
            // this triggers the loading of all the future queries
            var count = q2.GetValueAsync().Result;
            Assert.NotEqual(count, 0);
        ...
        public void FutureValueTest()
            ...
            // this triggers the loading of all the future queries
            User user = q1.GetValueAsync().Result;
            Assert.NotNull(user);
        ...
        public void FutureValueReverseTest()
            ...
            var users = q1.GetValueAsync().Result;
            Assert.NotNull(users);

            var tasks = q3.ToListAsync().Result;
            Assert.NotNull(tasks);
        ...
        public void FutureValueWithAggregateFunctions()
            ...
            var r1 = q1.GetValueAsync().Result;
            var r2 = q2.GetValueAsync().Result;
            var r3 = q3.GetValueAsync().Result;
        ...
        public void LoggingInterception()
            ...
            //materialize it
            var user = q1.GetValueAsync().Result;
