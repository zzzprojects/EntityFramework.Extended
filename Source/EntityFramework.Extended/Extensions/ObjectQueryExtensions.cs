...
namespace EntityFramework.Extensions
{
    ...
    {
        /// <summary>
        /// Get the SQL that the query will run, along with the parameter values
        /// </summary>
        /// <typeparam name="TEntity">The type of the entity.</typeparam>
        /// <param name="query">The query to get the SQL for.</param>
        /// <returns>The SQL that the query will run, along with the parameter values</returns>
        public static string ToTraceString<TEntity>(this IQueryable<TEntity> query) where TEntity : class
        {
            ...
            foreach (var parm in objectQuery.Parameters)
            {
                sb.AppendFormat("{0}: {1}", parm.Name, parm.Value).AppendLine();
            }
        ...
        public static ObjectQuery ToObjectQuery(this IQueryable query)
        {
            ...
            if (dbQuery == null)
            {
                ...
                return (ObjectQuery)prop.GetValue(query, null);
            }
